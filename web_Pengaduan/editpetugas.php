	...
	<div class="content">
		...
		<form action="updatepetugas.php" method="POST">
			...
			<div class="input-group">
				<input type="text"  value="<?php echo $tampil['id_petugas']; ?>" name="id_petugas">
			</div>

			<div class="input-group">
				<input type="text"  name="nama_petugas" value="<?php echo $tampil['nama_petugas']; ?>" >
			</div>
			...
			<div class="input-group">
						<select name="level" id="" >
							<option value="<?php echo $tampil['level']; ?>">-Level-</option>
